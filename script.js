...
// Function to create the dynamic message section
...
// Function to create the animated box
function initializeAnimatedBox() {
...
// Function to handle recipe filtering
function initializeRecipeFilter() {
  ...
  recipeFilterForm.addEventListener("submit", (event) => {
    ...
    displayRecipes(filteredRecipes, recipeResults);
  });
}
